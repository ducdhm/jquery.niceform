...
| regex.email                   | RegExp   | Regular expression for email field. <br />Default: `/^(?:[a-z0-9!#$%&'*+/=?^_`{                                                                                                                                            |
| regex.url                     | RegExp   | Regular expression for url field. <br />Default: `/^(https?:\/\/)?([\da-z\.-]+)\.([a-z\.]{2,6})([\/\w \.-]*)*\/?$/`                                                                                                        |
